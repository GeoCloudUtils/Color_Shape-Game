...
namespace Audio
{
    ...
    public class PlayingAudio
    {
        ...
        public PlayingAudio(AudioType audioType, AudioClip clip, bool loop, bool persist, float volume, float fadeInValue, float fadeOutValue, Transform sourceTransform)
        {
            // Set unique audio ID
